...
public class ConsumerKafkaConfiguration {
    ...
    public ConsumerFactory<String, String> consumerFactory () {
        ...
        config.put(org.apache.kafka.clients.consumer.ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.23.239.143:9092");
    ...
    @Bean
    public ConsumerFactory<String, PdfDocument> fileConsumerFactory () {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(PdfDocument.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PdfDocument> fileKafkaListenerFactory () {
        ConcurrentKafkaListenerContainerFactory<String, PdfDocument> factory = new ConcurrentKafkaListenerContainerFactory<>();
