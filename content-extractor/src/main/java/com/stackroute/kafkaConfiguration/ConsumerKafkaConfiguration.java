...
public class ConsumerKafkaConfiguration {
    ...
    public ConsumerFactory<String, String> consumerFactory () {
        ...
        config.put(org.apache.kafka.clients.consumer.ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.23.239.145:9092");
    ...
    @Bean
    public ConsumerFactory<String, FileUrl> fileConsumerFactory () {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(FileUrl.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, FileUrl> fileKafkaListenerFactory () {
        ConcurrentKafkaListenerContainerFactory<String, FileUrl> factory = new ConcurrentKafkaListenerContainerFactory<>();
