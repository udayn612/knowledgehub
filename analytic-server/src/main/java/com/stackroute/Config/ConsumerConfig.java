...
public class ConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory () {
        ...
        config.put(org.apache.kafka.clients.consumer.ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "172.23.239.176:9092");
    ...
    @Bean
    public ConsumerFactory<String, Paragraph> userConsumerFactory () {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(Paragraph.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Paragraph> userKafkaListenerFactory () {
        ConcurrentKafkaListenerContainerFactory<String, Paragraph> factory = new ConcurrentKafkaListenerContainerFactory<>();
